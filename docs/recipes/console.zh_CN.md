...
import { getRecordConsolePlugin } from '@posthog-internal/rrweb-plugin-console-record';
...
```js
import rrweb from '@posthog-internal/rrweb';
import { getReplayConsolePlugin } from '@posthog-internal/rrweb-plugin-console-replay';
