...
import { RRWebPluginCanvasWebRTCRecord } from '@posthog-internal/rrweb-plugin-canvas-webrtc-record';
...
// Replay side
import rrweb from '@posthog-internal/rrweb';
import { RRWebPluginCanvasWebRTCReplay } from '@posthog-internal/rrweb-plugin-canvas-webrtc-replay';
